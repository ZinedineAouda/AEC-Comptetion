...
def generate_full_database():
    ...
    # Relocate to data/ folder
    import os
    output_path = '../data/communes_rpa.json' if os.path.exists('../data') else 'communes_rpa.json'
    with open(output_path, 'w', encoding='utf-8') as f:
        json.dump(db, f, indent=4)
    print(f"Full 1-58 RPA database created as {output_path}")
